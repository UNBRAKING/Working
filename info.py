...
# Pyrogram Client
    ...
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "7300051594:AAHWsJQZl8ZXOs9-tjcSz90LTqur1v5c6vs")  # ⚠️ Required

    # Other Configs
    BOT_START_TIME = time.time()
    OWNER = int(os.environ.get("OWNER", "6621610889"))  # ⚠️ Required
    SUDO = list(map(int, os.environ.get("SUDO", "6621610889 6437126736 5460343986").split()))  # ⚠️ Required
    # Web Response Config
